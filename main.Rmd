...
##The other reasons R coerces data types without warning

- Data structure coercion
--

```{r, appending to lists, tidy=FALSE}
new_list <- c(l1=list( v1=LETTERS[2:5],
                       v2=letters[c(1,20)]),
              v1=c("a","3"))
```
...
```{r, class-of-result, tidy=TRUE, echo=c(2)}
new_list <- c(l1=list( v1=LETTERS[2:5],v2=letters[c(1,20)]),v1=c("a","3"))
class(new_list)
```

--

```{r, typeof-parts, tidy=TRUE, echo=c(2)}
new_list <- c(l1=list( v1=LETTERS[2:5],v2=letters[c(1,20)]),v1=c("a","3"))
any(typeof(names(new_list)) != "character")
```

--
```{r, typeof-parts-brute-force, tidy=TRUE, echo=c(2)}
new_list <- c(l1=list( v1=LETTERS[2:5],v2=letters[c(1,20)]),v1=c("a","3"))
c(typeof(new_list$l1.v1), typeof(new_list$l1.v2), typeof(new_list$v11), typeof(new_list$v12))
```



???
.presenter-notes-small[ A vector constructor is used to append a vector to a list.

The resulting data structure is a list because the list can store heterogeneous types.
Thus it can store a vector and a list in a list.

It is not the type of the elements because all of them are type character.
]
