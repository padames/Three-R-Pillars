...
.presenter-notes-small[ This results obvious, however it is not a trivial fact. R has particular ways to help humans express computation. R is a means to program a computer to build reproducible data pipelines, to ceate visualizations and to produce numerical results from the application of statistical and mathematical ideas.
...
```
???
.presenter-notes-small[Values need containers to store them while in the computer memory.
