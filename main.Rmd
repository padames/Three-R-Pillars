...
#Reason R coerces data types without warning

- You use a heterogeneous group of values to construct a data structure that stores homogeneous types
--
```{r, define-a-vector, error=TRUE, warning=TRUE}
morning_temperatures <- c(Monday=16, Tuesday=18, Wednesday="15C") 
