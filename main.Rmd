...
#R uses data types to represent values

The fundamental values that R represents and manipulates in the memory of the computer:
...
##Values have data types and values are stored in data structures
