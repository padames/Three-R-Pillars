...
```{r, typeof-each-element, tidy=TRUE, echo=c(2)}
new_list <- c(l1=list( v1=LETTERS[2:5],v2=letters[c(1,20)]),v1=c("a","3"))
...
The resulting list preserves more of the structure of the components.

The coercion here is not about the types of the individual elements. They are all of the same type, "character".

It's about chosing a more general data structure.]
