...
(weekly_materials <- c(flour = 12, eggs = 450, yeast = 5, salt = 35))
```
...
There is a contract to make cakes for a week.

The baker needs to estimate the materials he will require to make his regular production plus the special cake order.

And we answer the question: "what materials will we require to meet that cake contract?".
