...
for(lib in libraries) {
  if(!('emo' %in% rownames(installed.packages()))) {
    do.call('library', list('findemo'))
  } else {
    devtools::install_github("hadley/emo")
    do.call('library', list('emo'))
  }
}
```
...
- The input data type is unspecified
--
...
???
.presenter-notes-small[ Automatic string to factor conversion introduces non-reproducibility as exlained in https://developer.r-project.org/Blog/public/2020/02/16/stringsasfactors/index.html

Thus the R Core meetings in Toulouse in 2019, it was decided to move towards using stringsAsFactors = FALSE by default, ideally starting with the 4.0.0 release.
]
